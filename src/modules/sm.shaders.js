csecLib.showModuleInfo("sm.shaders.js", "3D Shader Definitions");	
...
ColorPs = {
    ...
    for (var s = eash.ind++, t = "", a = ["", "", "", ""], n = 0, i = 0; i < e.length; i++) def(e[i].r) || (e[i] = {
        r: e[i],
        e: 1
    }), t += " vec4 result_" + s + "_" + i + ";result_" + s + "_" + i + " = vec4(0.,0.,0.,0.); float rp_" + s + "_" + i + " = " + _cs(e[i].e) + "; \n", t += e[i].r + "\n", t += " result_" + s + "_" + i + " = result; \n", a[0] += (0 == i ? "" : " + ") + "result_" + s + "_" + i + ".x*rp_" + s + "_" + i, a[1] += (0 == i ? "" : " + ") + "result_" + s + "_" + i + ".y*rp_" + s + "_" + i, a[2] += (0 == i ? "" : " + ") + "result_" + s + "_" + i + ".z*rp_" + s + "_" + i, a[3] += (0 == i ? "" : " + ") + "result_" + s + "_" + i + ".w*rp_" + s + "_" + i, n += e[i].e;
    ...
    i && (l = "min(1.0, max(0.,(ref.x*" + _cs(n) + "-" + _cs(a) + ")))", f = "min(1.0, max(0.,(ref.y*" + _cs(n) + "-" + _cs(a) + ")))", _ = "min(1.0, max(0.,(ref.z*" + _cs(n) + "-" + _cs(a) + ")))");
    var u = " && ",
        d = " + ",
        h = "",
        p = "";
    switch (e.type) {
        case white:
            p = l + c + u + f + c + u + _ + c, h = "(" + l + d + f + d + _ + ")/3.0";
            break;
        case cyan:
            p = l + o + u + f + c + u + _ + c, h = "(" + f + d + _ + ")/2.0 - (" + l + ")/1.0";
            break;
        case pink:
            p = l + c + u + f + o + u + _ + c, h = "(" + l + d + _ + ")/2.0 - (" + f + ")/1.0";
            break;
        case yellow:
            p = l + c + u + f + c + u + _ + o, h = "(" + l + d + f + ")/2.0 - (" + _ + ")/1.0";
            break;
        case blue:
            p = l + o + u + f + o + u + _ + c, h = "(" + _ + ")/1.0 - (" + l + d + f + ")/2.0";
            break;
        case red:
            p = l + c + u + f + o + u + _ + o, h = "(" + l + ")/1.0 - (" + f + d + _ + ")/2.0";
            break;
        case green:
            p = l + o + u + f + c + u + _ + o, h = "(" + f + ")/1.0 - (" + l + d + _ + ")/2.0";
            break;
        case black:
            p = l + o + u + f + o + u + _ + o, h = "1.0-(" + l + d + f + d + _ + ")/3.0"
    }
    return " if( " + p + " ) { vec4 oldrs_" + r + "_ = vec4(result);float al_" + r + "_ = max(0.0,min(1.0," + h + "+(" + _cs(t) + "))); float  l_" + r + "_ =  1.0-al_" + r + "_;  " + e.mat + " result = result*al_" + r + "_ +  oldrs_" + r + "_ * l_" + r + "_;    }"
    ...
    e = def(e, {}), e.l = def(e.l, .55), e.dir1 = def(e.dir1, "vec2(-" + _cs(e.l) + ",-" + _cs(e.l) + ")"), e.dir2 = def(e.dir2, "vec2(" + _cs(e.l) + "," + _cs(e.l) + ")"), e.dir3 = def(e.dir3, "vec2(" + _cs(e.l) + ",-" + _cs(e.l) + ")"), e.dir4 = def(e.dir4, "vec2(-" + _cs(e.l) + "," + _cs(e.l) + ")"), e.r = def(e.r, 4.5), e.d = def(e.d, .001), e.mapInd = def(e.mapInd, 0), e.dir = def(e.dir, {
        x: 1,
        y: 0
    });
    var r = function (r) {
