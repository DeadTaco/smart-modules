...
SmartModule.addModule("ui", ( 
    {
        description : ["ui", "User interface: Dynamic HTML, text popups, and user interface objects"],
        requires : ["fileio"],
        version : "1.0",
        ...
        /* Creates a dialog box object with provided options
            ...
            html : Dialog Box Content
            width : Starting Width (pixels or css value)
            height : Starting Height (pixels or css value)
        */
